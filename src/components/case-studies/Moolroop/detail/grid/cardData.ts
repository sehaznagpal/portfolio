...
export const MOTIVATION_PHOTOS: PolaroidSpec[] = [
  { src: kachipuramSilk, alt: 'Kanchipuram silk saree', cx: 16.4, cy: 85.3, width: 22.0, height: 39.9, rotate: 8.45 },
  { src: brassware, alt: 'Engraved brassware tankard', cx: 37.6, cy: 86.9, width: 20.9, height: 36.2, rotate: -2.5 },
  { src: pashmina, alt: 'Hand-embroidered Pashmina', cx: 60.0, cy: 89.0, width: 21.2, height: 47.4, rotate: 2.38 },
  { src: khurjaPottery, alt: 'Khurja blue pottery', cx: 83.5, cy: 85.5, width: 22.4, height: 43.9, rotate: -5.05 },
];
