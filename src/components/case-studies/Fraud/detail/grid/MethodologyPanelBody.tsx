    ...
    <>
      ...
      <div className={styles.content}>
        <p className={styles.intro}>
          ...
          structured case study analysis of six international behavioural anti-fraud
          interventions (selected on four dimensions), and a supplementary experiment testing one
          dimension of that analysis empirically. The case analysis carries the paper&apos;s main
          argument, the experiment gives it a controlled, if narrower, piece of evidence.
        </p>

        <div className={styles.columns}>
          <div className={styles.column}>
            <h3 className={`${styles.subheading} ${styles.lensHeading}`}>
              The four-dimension lens
            </h3>
          ...
          <div className={styles.column}>
            <h3 className={`${styles.subheading} ${styles.casesHeading}`}>
              Choosing the six cases
            </h3>
            <div className={styles.casesBox}>
              <p className={styles.casesText}>
                ...
                <span className={styles.highlight}>
                  UK&apos;s APP fraud experiments, Alipay&apos;s warning redesign, a five-country
                  PMT study, a Nigerian anti-fraud trial, Singapore&apos;s Scamshield
                  architecture, and Australia&apos;s Scamwatch campaigns.
                </span>
              </p>
            </div>
          </div>
