  ...
  return (
    <>
      ...
      <p className={styles.intro}>
        ...
        <span className={styles.highlight}>Google Apps Script backend</span> logging decisions in
        real time. Light mode, mobile-only, an exit icon exactly where a real payment app puts
        one.
      </p>
      ...
      <ul className={styles.list}>
        ...
        <li>
          <span className={styles.highlight}>Urgency</span> — an unknown number, later revealed as
          a friend who lost their phone, asking for an urgent transfer
        </li>
        <li>
