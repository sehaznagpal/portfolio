...
import { useCardScale } from '../../lib/useCardScale';
...
/* Hero (806x468) and case-study (984x554) cards are genuinely different sizes in
   ...
   The whole assembly is wrapped in a uniform scale (useCardScale) so the card grows
   or shrinks with the viewport without ever stretching non-uniformly — every pixel
   position inside Hero/CaseStudyShell stays exactly as authored at any scale. */
